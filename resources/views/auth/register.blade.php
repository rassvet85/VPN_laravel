                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-12 form-label" for="fname">Your name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="emailverify" class="form-control @error('email') is-invalid @enderror" placeholder="Email for verification"  value="{{ old('email') }}" required>
                                        <div class="invalid-feedback">No, you missed this one.</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" id="userpassword" placeholder="Password" class="form-control @error('password') is-invalid @enderror" placeholder="minimm 8 characters" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password-confirm" name="password_confirmation" placeholder="Confirm Password" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
